...
def you_forgot_something():
    ...
    # Your Answer: = is to set a vaiable to a number. == is to see if a vaiable or a function is equal to each other.
...
def giving_functions_the_wrong_stuff():
    ...
    my_int_2 = int("5") # What happens if we try to pass a non-number?
